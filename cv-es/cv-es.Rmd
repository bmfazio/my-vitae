...
tribble(
  ...
  "Especialista en Seguimiento y Gestión Territorial", fbvl, limape, "Ene. 2021 - Presente",
  'Nexo entre equipo de diseño de políticas y equipo de desarrollo para el recojo e implementación de necesidades del aplicativo de la Estrategia de Gestión Territorial "Primero la Infancia" (EGTPI)',
  "Especialista en Seguimiento y Gestión Territorial", fbvl, limape, "Ene. 2021 - Presente",
  "Desarrollo de reportes estandarizados para el seguimiento de la implementación e impacto de la EGTPI",
  "Especialista en Seguimiento y Gestión Territorial", fbvl, limape, "Ene. 2021 - Presente",
  "Evaluación de la usabilidad y experiencia de usuario en el aplicativo EGTPI",
